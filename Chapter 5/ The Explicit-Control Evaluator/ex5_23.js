...
controller(
    ...
    "compound_apply",
        ...
        save(constant(marker)), // changed for ex 5.53
        assign("continue", label("return_undefined")),
        go_to(label("ev_dispatch")),
    // changed for ex 5.53
    "ev_return",
        restore(reg("temp")),
        test([op("eq"), reg("temp"), constant(marker)]),
        branch(label("ev_restore_done")),
        go_to(label("ev_restore_loop")),
    "ev_restore_done",
        restore("continue"),
        go_to(reg("continue")),
    ...
    */
    ...
    "return_undefined",
        restore(reg("temp")),
        test([op("eq"), reg("temp"), constant(marker)]),
        branch(label("return_undefined_done")),
        go_to(label("return_undefined_loop")),
    "return_undefined_done",
        restore("continue"),
        assign("val", constant(undefined)),
        go_to(reg("continue")),
    "ev_restore_stack",
