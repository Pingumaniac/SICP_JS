...
controller(
    ...
    "eval-dispatch",
        ...
        // ex 5.33 part (a)
        test([op("is_application_with_symbol"), reg("comp")]),
        branch(label("ev_application_with_symbol")),
        // end of ex 5.33 part (a)
    ...
    "ev_name",
        ...
        go_to(reg("continue")),
    // ex 5.33 part (a)
    "ev_application_with_symbol",
        assign("unev", [op("operands"), reg("comp")]),
        assign("fun", [op("lookup_symbol_value"), [op("operator"), reg("comp")], reg("env")]),
    // end of ex 5.33 part (a)
    "ev_lambda",
...
/*
Part (b): Alyssa's suggestion is right.
It will make the compiler more complex and less efficient
as it recognizes more and more special cases.
*/
