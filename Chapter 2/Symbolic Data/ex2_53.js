...
// ex 2.53
console.log(print_list(list("a", "b" , "c")));
console.log(print_list(list(list("george"))));
console.log(print_list(tail(list(list("x1", "x2"), list("y1", "y2")))));
console.log(print_list(tail(head(list(list("x1", "x2"), list("y1", "y2"))))));
console.log(member("red", list("blue", "shoes", "yellow", "socks")));
console.log(member("red", list("red", "shoes", "blue", "socks")));
