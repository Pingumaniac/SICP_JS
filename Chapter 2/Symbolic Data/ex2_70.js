...
const test_list = list(list("A", 2), list("NA", 16), list("BOOM", 1), list("SHA", 3), list("GET", 2), list("YIP", 9), list("JOB", 2), list("WAH", 1));
const sample_huffman_tree = generate_huffman_tree(test_list);
const sample_message1 = list("GET", "A", "JOB");
console.log(print_list(encode(sample_message1, sample_huffman_tree)));
console.log(print_list(decode(encode(sample_message1, sample_huffman_tree), sample_huffman_tree)));
const sample_message2 = list("SHA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA");
console.log(print_list(encode(sample_message2, sample_huffman_tree)));
console.log(print_list(decode(encode(sample_message2, sample_huffman_tree), sample_huffman_tree)));
const sample_message3 = list("WAH", "YIP", "YIP", "YIP", "YIP", "YIP", "YIP", "YIP", "YIP", "YIP");
console.log(print_list(encode(sample_message3, sample_huffman_tree)));
console.log(print_list(decode(encode(sample_message3, sample_huffman_tree), sample_huffman_tree)));
const sample_message4 = list("SHA", "BOOM");
console.log(print_list(encode(sample_message4, sample_huffman_tree)));
console.log(print_list(decode(encode(sample_message4, sample_huffman_tree), sample_huffman_tree)));
