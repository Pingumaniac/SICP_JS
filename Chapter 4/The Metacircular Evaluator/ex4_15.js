...
function strage(f) { return halts(f, f) ? run_forever() : "halted"; }

This is equivalent to the halting problem, which is undecidable.

Case 1: If strange(strange) = "halted",
halts(strange, strange) === false,
then strange(strange) = run_forever().
Contradiction.

Case 2: If strange(strange) = run_forever(),
halts(strange, strange) === true,
then strange(strange) = "halted".
Contradiction.
*/
