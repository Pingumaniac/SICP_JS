...
function analyze(component) {
    ...
    } else if (is_permanent_assignment(component)) {
        return analyze_permanent_assignment(component);
    } else if (is_evaluation_succeed_take(component)) {
        return analyze_evaluation_succeed_take(component);
    } else if (is_require(component)) {
...
// ex 4.52
function is_require(component) { return is_tagged_list(component, "require"); }
...
function analyze_require(component) {
    ...
    return (env, succeed, fail) => pfun(env, (pred_value, fail2) =>
    is_truthy(pred_value) ? succeed("ok", fail2) : fail(), fail2);
}
// end of ex 4.52
